...
if (get('restart')) {
 ...
 <body>
 	...
 	<div class="customnav">
 		<div class="nav1">
 			<div class="dp"></div>
 			<div class="navtime"><?php echo date("h:i") ?> <span style="font-weight:lighter"><?php echo date("A") ?></span></div>
 			<div class="dp2"></div>
 	...
 	<div class="row">
 		...
 		<div class="col">
			...
			<div class="title">Device Consumed</div>
 				<div class="bg-circle" style="color: #3960fd">
                    <img src="assets/svgs/energy1.svg" style="width: 50px; height: 50px;margin-right: -10px;"/>
 					<?php echo $total_energy_consumed;?>
				</div>
 		...
 		<div class="col">
			...
			<div class="title">Devices</div>
 				<div class="bg-circle" style="color: brown">
